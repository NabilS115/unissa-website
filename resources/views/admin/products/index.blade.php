        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 mb-8">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 mb-8">
                ...
                <div class="bg-yellow-50 rounded-xl p-4 border border-yellow-200 hover:shadow-md transition-shadow">
                    <div class="text-2xl font-bold text-yellow-700">{{ $stats['low_stock'] ?? 0 }}</div>
                ...
                <div class="bg-purple-50 rounded-xl p-4 border border-purple-200 hover:shadow-md transition-shadow">
                    <div class="text-2xl font-bold text-purple-700">{{ $stats['discontinued'] ?? 0 }}</div>
                    <div class="text-sm text-purple-600">Discontinued</div>
                </div>
                <div class="bg-teal-50 rounded-xl p-4 border border-teal-200 hover:shadow-md transition-shadow">
                    <div class="text-lg font-bold text-teal-700">{{ $stats['recent_products'] ?? 0 }}</div>
