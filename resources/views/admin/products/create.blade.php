...
function productForm() {
    return {
        ...
        finishCrop() {
            if (this.cropper) {
                this.cropper.getCroppedCanvas({
                    ...
                    // Set hidden input for cropped image data
                    const reader = new FileReader();
                    reader.onload = () => {
                        document.getElementById('cropped-data').value = reader.result;
                    };
        ...
        resetCropper() {
            ...
            document.getElementById('cropped-data').value = '';
        },
        ...
        async submitProduct() {
            const formElement = this.$refs.productForm;
