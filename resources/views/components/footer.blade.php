    ...
    <div class="flex flex-col md:flex-row gap-8 w-full md:w-auto justify-center">
        ...
        <div class="bg-[#007070] bg-opacity-80 rounded-2xl px-8 py-6 flex flex-col items-center min-w-[200px]">
            ...
            <div class="flex gap-4 mb-4">
                ...
                <a href="#" class="text-white" title="X (FKA Twitter)">
                    <!-- X Official SVG: exact path, uses currentColor for color consistency -->
                    <svg width="24" height="24" viewBox="0 0 512 512" fill="none">
                        <path d="M437.252 80H338.748L256 196.252 173.252 80H74.748L208.252 256 74.748 432H173.252L256 315.748 338.748 432h98.504L303.748 256z" fill="currentColor"/>
                    </svg>
                </a>
            </div>
