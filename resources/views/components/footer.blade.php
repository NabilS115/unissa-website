        ...
        <div class="bg-[#007070] bg-opacity-80 rounded-2xl px-8 py-6 flex flex-col items-center min-w-[200px]">
            ...
            <div class="flex gap-4 mb-4">
                ...
                <a href="#" class="text-white" title="Twitter">
                    <svg width="24" height="24" viewBox="0 0 512 512" fill="currentColor"><path d="M459.4 151.7c.32 4.54.32 9.1.32 13.66 0 138.72-105.58 298.56-298.56 298.56-59.5 0-114.68-17.22-161.14-47.11 8.44.97 16.86 1.44 25.6 1.44 49.3 0 94.6-16.86 132.1-45.81-46.1-.97-84.8-31.3-98.1-73.1 6.5.97 13.1 1.94 20.1 1.94 9.42 0 18.84-1.3 27.61-3.64-48.08-9.7-84.12-51.98-84.12-102.98v-1.3c14.08 7.83 30.18 12.55 47.43 13.1-28.26-18.84-46.1-51.01-46.1-87.39 0-19.42 5.2-37.36 14.3-52.95 51.98 63.7 129.3 105.58 216.36 110.06-1.62-7.76-2.59-15.85-2.59-24.01 0-57.78 46.92-104.7 104.7-104.7 30.18 0 57.5 12.55 76.67 32.77 23.87-4.54 46.1-13.42 66.24-25.6-7.83 24.48-24.48 44.83-46.1 57.78 21.24-2.27 41.53-8.21 60.34-16.61-14.08 20.79-31.62 39.31-51.82 54.25z"/></svg>
                </a>
            </div>
