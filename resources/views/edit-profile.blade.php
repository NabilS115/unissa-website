...
<div class="max-w-2xl mx-auto bg-white rounded-lg shadow p-8 mt-8">
    <div class="flex items-center gap-4 mb-6">
        <div class="relative group">
            ...
            <form method="POST" action="{{ route('profile.photo') }}" enctype="multipart/form-data" class="absolute inset-0 flex items-center justify-center">
                @csrf
                <label for="profile_photo" class="absolute inset-0 flex items-center justify-center cursor-pointer bg-black bg-opacity-0 group-hover:bg-opacity-40 rounded-full transition">
                    <svg xmlns="http://www.w3.org/2000/svg" class="opacity-0 group-hover:opacity-80 transition" width="36" height="36" fill="none" viewBox="0 0 24 24" stroke="white">
